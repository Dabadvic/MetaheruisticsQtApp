...
{
public:
    Agg(const vector<vector<int> > &distances, const vector<vector<int> > &flow, int type, int seed = 123456, int evaluations = 20000, int population = 50, float crossProbability = 0.7, float mutationProbability = 0.01);
    int getCost();

...
{
public:
    LocalSearch(const vector<vector<int> > &distances, const vector<vector<int> > &flow, const vector<int> &solution, int seed = 123456, bool useGiven = false, int solutionsToCheck = 10000);
    int search();
    int getCost();
